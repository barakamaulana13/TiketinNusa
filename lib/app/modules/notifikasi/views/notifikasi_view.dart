...
class NotifikasiView extends StatelessWidget {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: GetBuilder<PengaturanController>(
          builder: (_) => Text(
            Get.find<PengaturanController>().t('notif_title'),
        ...
        actions: [
          Obx(
            () => c.notifications.isNotEmpty
                ? IconButton(
                    icon: const Icon(Icons.delete_sweep, color: Colors.white),
                    onPressed: () => _konfirmasiHapusSemua(context, c, lang),
                  )
  ...
  Widget _buildCard(Map<String, dynamic> item, NotifikasiController c) {
    return Dismissible(
